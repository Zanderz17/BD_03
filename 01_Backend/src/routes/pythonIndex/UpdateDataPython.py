...
from routes.principalClass.UBetterFixEverything import UBetterFixEverything
...
def UpdateDataPython(size):
    ...
    current_app.config['PrincipalClass'] = UBetterFixEverything("yes")
    ...
    result = {'mensaje': f'Objeto principal con {size} documentos creado con éxito', 'execution_time':execution_time}
